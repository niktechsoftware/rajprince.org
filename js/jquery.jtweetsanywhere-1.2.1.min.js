(function (e)
{
    ...
    defaultTweetUsernameDecorator = function (a, b)
    {
        var c = a.retweeted_status || a,
            d = c.user ? c.user.screen_name : c.from_user;
    ...
    defaultTweetTimestampDecorator = function (a, b)
    {
        var c = a.retweeted_status || a,
            ...
            f = b.tweetTimestampFormatter(d),
            g = b.tweetTimestampTooltipFormatter(d);
    ...
    {
        var b = parseInt(((new Date).getTime() - Date.parse(a)) / 1E3),
            c = "";
    ...
    {
        for (var c = b._tweetsCache.length, d = 0; d < c; d++) if (a.id == b._tweetsCache[d].id) return true;
        return false
    };
    ...
    getRecPagedTweets = function (a, b, c, d)
    {
        ...
        else
        {
            ...
            {
                var j = k.results || k;
                if (j.length == 0) h._tweetFeedConfig._noData = true;
                else e.each(j, function (l, i)
                {
